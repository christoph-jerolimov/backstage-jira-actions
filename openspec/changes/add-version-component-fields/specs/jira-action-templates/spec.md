...
- **WHEN** a user runs any of the list-returning test templates (`list-projects`, `list-issue-types`, `search-work-items`, `search-users`, `list-transitions`, `list-link-types`, `list-fields`, `list-versions`, `list-components`, `list-boards`, or `list-sprints`)
