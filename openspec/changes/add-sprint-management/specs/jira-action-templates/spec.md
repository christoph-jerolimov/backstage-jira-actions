...
- **WHEN** a user opens the `create-work-item`, `search-work-items`, `list-issue-types`, `list-versions`, `list-components`, or `create-version` test template
...
- **WHEN** a user runs any of the list-returning test templates (`list-projects`, `list-issue-types`, `search-work-items`, `list-sprint-work-items`, `search-users`, `list-transitions`, `list-link-types`, `list-fields`, `list-versions`, `list-components`, `get-remote-links`, `list-boards`, or `list-sprints`)
