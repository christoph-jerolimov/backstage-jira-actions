...
- **THEN** the form asks for the action's inputs (projectKey, issueType, summary as required; description, labels, assignee, parentKey, host as optional)
